...
export const desktop = {
  ...
  checkHeadroomInstalled: () => call<boolean>("CheckHeadroomInstalled"),
  installHeadroom: () => call<void>("InstallHeadroom"),
  ...
  startCodexOAuthLogin: (mode: string) => call<DesktopCodexLoginResult>("StartCodexOAuthLogin", mode),
  completeCodexOAuthLogin: () => call<ProviderAccount>("CompleteCodexOAuthLogin"),
  checkCodexInstalled: () => call<DesktopCodexLoginResult>("CheckCodexInstalled"),
